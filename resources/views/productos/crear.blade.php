                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="Ingrese el nombre del producto" required name="nombre" id="nombre">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="descripcion" id="descripcion" required cols="30"
                                            ...
                                            placeholder="Ingresa alguna descripcion"></textarea>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputFile1" name="imagen" required type="file" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="precio">Precio</label>
                                        <input type="number" placeholder="Ingrese el precio del producto"
                                            class="form-control" required name="precio" id="precio">
                                    </div>
                                </div>
